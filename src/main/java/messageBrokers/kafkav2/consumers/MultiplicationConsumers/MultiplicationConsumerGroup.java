package messageBrokers.kafkav2v2.consumers.MultiplicationConsumers;
...
@ToString
public class MultiplicationConsumerGroup implements IConsumerGroup {
    ...
    public MultiplicationConsumerGroup(Topic topic, String groupID, ConsumerGroupState state) {
    ...
    public void publish(Message message) {
        ...
        synchronized (state){
            state.notifyAll();
//            System.out.println("Notified Multiplication Consumers");
